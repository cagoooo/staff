    ...
    container.innerHTML = `
        <div class="mt-4 pt-4 border-t-2 border-gray-200">
            <h4 style="font-family: 'VT323', monospace; font-size: 20px; margin-bottom: 12px;">
                💬 留言 (${_currentEventComments.length})
            </h4>
            ...
            '<p class="text-gray-400 text-center py-4" style="font-family: \'VT323\', monospace;">還沒有留言，來說點什麼吧！</p>' :
    ...
    modal.innerHTML = `
        <div style="background: white; border-radius: 12px; width: 100%; max-width: 450px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
            <div style="padding: 16px; border-bottom: 2px solid #dfe6e9;">
                <h3 style="font-family: 'VT323', monospace; font-size: 24px; margin: 0; color: #2d3436;">✏️ 編輯留言</h3>
            </div>
